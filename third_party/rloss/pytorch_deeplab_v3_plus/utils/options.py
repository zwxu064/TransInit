...
def set_config():
  ...
  parser.add_argument('--sigma-xy', type=float, default=80.0, help='DenseCRF sigma_xy')
  ...
  # MPLayer
  parser.add_argument('--mpnet_n_dirs', type=int, default=4, help='number of directions')
  ...
  parser.add_argument('--mpnet_term_weight', type=float, default=5, help='term weight')
  ...
  # Edge weights
  parser.add_argument('--mpnet_scale_list', nargs='+', type=float, default=0.25, help='scale list for edge weights')
  ...
  parser.add_argument('--context_weight_decay', type=float, default=5e-4, metavar='M',
