...
from ..custom_transforms import Normalize, ToTensor, AutoAdjustSize, ColorJitter
...
class CityscapesSegmentation(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        image_name = os.path.basename(img_path)[:-16]
        ...
        sample = {'image': _img, 'label': _target,
                  'padding_mask': _padding_mask, 'size': (_img.height, _img.width),
                  'name': image_name}
    ...
    def transform_tr(self, sample):
        composed_transforms = transforms.Compose([
            ...
            ColorJitter(),
            RandomScaleCrop(base_size=self.args.base_size, crop_size=self.args.crop_size, fill=255),
            RandomGaussianBlur(),
